...
public class Informacion_Cliente extends javax.swing.JFrame {
    ...
    public Informacion_Cliente() {
        ...
        try {
            ...
            if (rs.next()) {
                setTitle("Información del cliente " + rs.getString("nombre_cliente") + " - Sesíon de " + user);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane_equipos, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 370, 180));
        ...
        getContentPane().add(jButton_ImprimirReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 250, 110, 100));
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
        ...
        try {
            ...
            try {
                ...
                System.err.println("Error al obtener datos del usuario." + e);
            }
            documento.close();
            JOptionPane.showMessageDialog(null, "Reporte creado correctamente.");
        } catch (DocumentException | IOException e) {
            System.err.println("Error en PDF o ruta de imagen" + e);
            JOptionPane.showMessageDialog(null, "Error al generar PDF, conctacte al administrador" + e);
        }
