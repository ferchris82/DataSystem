...
public class AcercaDe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_1.setText("Sistema creado por ChrisferDev");
        getContentPane().add(jLabel_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, -1, -1));

        jLabel_2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel_2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_2.setText("La Casa de ChrisferDev");
        getContentPane().add(jLabel_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, -1, -1));
