...
public class InformacionEquipo extends javax.swing.JFrame {
    ...
    public InformacionEquipo() {
        ...
        try {
            ...
            System.err.println("Error al consultar el información del equipo");
        }
    ...
    private void initComponents() {
        ...
        jLabel_revisionTecnicaDe.setText("Comentarios y actualización tecnico:");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 130, 330, 110));

        jTextPane_comentariosTecnico.setEditable(false);
        jScrollPane2.setViewportView(jTextPane_comentariosTecnico);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, 330, 110));
        ...
        getContentPane().add(cmb_tipoequipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, -1, -1));
